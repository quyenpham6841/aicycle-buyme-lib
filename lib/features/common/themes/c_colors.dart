...
class CColors {
  ...
  static const Color lightTextPrimary = Color(0xFF282C39);
  ...
  static const Color crack = Color(0xFF7EFF8B);
  static const Color dent = Color(0xFFE7A3FF);
  static const Color torn = Color(0xFFFFF628);
  static const Color bend = Color(0xFFFF9F5A);
  static const Color other = Color(0xFFAD9FFF);
  static const Color neonTech = Color(0xFF01D6A8);
